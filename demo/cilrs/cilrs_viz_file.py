...
config = dict(
    ...
    policy=dict(
        ...
        collect=dict(
            n_episode=300,
            dir_path='/home/ywang3/workplace/datasets_train/datasets_train/cilrs_datasets_train',
            preloads_name='/home/ywang3/workplace/_preloads/cilrs_datasets_train.npy',
            collector=dict(
                suite='FullTown01-v1',
                nocrash=True,
            ),
