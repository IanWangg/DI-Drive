...
config = dict(
    ...
    policy=dict(
        ...
        model=dict(
            ...
            num_branch=4,
            backbone='resnet34',
            # pretrain_path='/home/ywang3/workplace/ACO-is-all-you-need/code/aco_interval1/checkpoint_0199.pth.tar',
    ...
    data=dict(
        ...
        val=dict(
            root_dir='/home/ywang3/workplace/datasets_train/datasets_train/cilrs_datasets_val',
            preloads='/home/ywang3/workplace/_preloads/cilrs_datasets_val.npy',
            transform=True,
            shrink='size:20000',
        ),
    )
...
def main(cfg):
    name = f'lr:{cfg.policy.learn.lr}, shrink:{cfg.data.train.shrink}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--aco', action='store_true')
    ...
    if args.aco:
        main_config.policy.model.pretrain_path = \
        f"/home/ywang3/workplace/ACO-is-all-you-need/code/aco{'_seq'+str(args.seq) if args.seq > 1 else ''}_interval{args.interval}/checkpoint_0199.pth.tar"
    
    if args.exp_name is not None:
        main_config.exp_name = args.exp_name
    main_config.policy.learn.lr=args.lr
    main_config.data.train.shrink = f'size:{args.size}'
    main(main_config)
